          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <div className="flex justify-center">
                <Button size="lg" className="h-16 px-10 rounded-full text-lg flex items-center gap-3 shadow-lg shadow-primary/25" onClick={() => window.open("https://www.mediafire.com/file/k9xjcjbubm3dsor/wanderly.apk", "_blank", "noopener,noreferrer")}>
